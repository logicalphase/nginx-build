...
ppa_lib_echo "3/15 nginx-auth-pam"
...
ppa_lib_echo "4/15 nginx-cache-purge"
...
ppa_lib_echo "5/15 nginx-dav-ext-module"
git clone https://github.com/arut/nginx-dav-ext-module.git \
|| ppa_error "Unable to clone nginx-dav-ext-module repo, exit status = " $?

ppa_lib_echo "6/15 nginx-development-kit"
...
ppa_lib_echo "9/15 ngx_http_substitutions_filter_module"
...
ppa_lib_echo "12/15 HttpRedisModule"
...
ppa_lib_echo "13/15 redis2-nginx-module"
git clone https://github.com/openresty/redis2-nginx-module.git \
|| ppa_error "Unable to clone redis2-nginx-module repo, exit status = " $?

ppa_lib_echo "14/15 ngx_devel_kit-module"
